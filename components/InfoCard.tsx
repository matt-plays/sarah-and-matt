...
export default function InfoCard({ overline, heading, body }: InfoCardProps) {
  return (
    <article className="border border-clay-50 rounded-2xl p-sp-md flex flex-col gap-6">
      {/* Overline */}
      <p
      ...
      {/* Heading */}
      <h3
        className="font-instrument font-medium text-cool-green-600 leading-tight tracking-tight font-instrument"
